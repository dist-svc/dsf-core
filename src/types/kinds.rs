...
pub mod kinds {
    ...
    pub const PING          : u16 = 0x0000 | REQUEST_FLAGS;
    pub const FIND_NODES    : u16 = 0x0001 | REQUEST_FLAGS;
    pub const FIND_VALUES   : u16 = 0x0002 | REQUEST_FLAGS;
    pub const STORE         : u16 = 0x0003 | REQUEST_FLAGS;

    pub const RESPONSE_FLAGS : u16 = 0x4000;
    pub const NO_RESULT     : u16 = 0x0000 | RESPONSE_FLAGS;
    pub const NODES_FOUND   : u16 = 0x0001 | RESPONSE_FLAGS;
    pub const VALUES_FOUND  : u16 = 0x0002 | RESPONSE_FLAGS;
...
mod tests {
    ...
    fn test_kinds() {
        let tests = vec![
            ...
            (Kind::Ping,            0b0010_0000_0000_0000),
            (Kind::FindNodes,       0b0010_0000_0000_0001),
            (Kind::FindValues,      0b0010_0000_0000_0010),
            (Kind::Store,           0b0010_0000_0000_0011),

            (Kind::NoResult,        0b0100_0000_0000_0000),
            (Kind::NodesFound,      0b0100_0000_0000_0001),
            (Kind::ValuesFound,     0b0100_0000_0000_0010),
