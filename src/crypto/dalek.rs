...
use ed25519_dalek::{Keypair, Signature, PublicKey as DalekPublicKey, SecretKey as DalekSecretKey, SignatureError};
...
pub fn pk_validate(public_key: &PublicKey, signature: &Signature, data: &[u8]) -> Result<bool, SignatureError> {
